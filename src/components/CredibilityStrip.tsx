    ...
    <div className="border-y border-black/[0.06]" style={{ background: "#f5f7fa" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-6">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          <span className="text-[#b0bec5] text-[10px] tracking-[0.35em] uppercase shrink-0">Partners &amp; Broadcast</span>
            ...
            {partners.map((p, i) => (
              <div key={p.name} className="flex items-center gap-4">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[#b0bec5] text-[10px] tracking-[0.15em] uppercase mt-0.5 whitespace-nowrap">{p.role}</span>
                </div>
                {i < partners.length - 1 && (
