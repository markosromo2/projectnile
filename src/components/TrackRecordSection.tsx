...
export default function TrackRecordSection() {
  return (
    <section id="leadership" className="overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              { value: "6+", num: 6, suf: "+", label: "Seasons Operating", sub: "Continuous, uninterrupted operations with the same ownership group" },
            ].map((s, i) => (
      ...
      {/* Paul Bragiel feature — no photo until better one is provided */}
      <div style={{ background: "#0d1520" }} className="py-0">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20 lg:py-24">
          <div data-animate className="rounded-sm overflow-hidden" style={{ border: "1px solid rgba(201,168,64,0.14)" }}>
            <div className="px-8 lg:px-12 pt-10 pb-4 flex items-center gap-4" style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
            ...
            <div className="p-8 lg:p-12">
              <div className="grid lg:grid-cols-2 gap-12 mb-10">
                <div>
                  <h3 className="text-4xl lg:text-5xl text-white font-light mb-6 leading-[0.92]" style={{ fontFamily: "var(--font-playfair)" }}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={s.label} className="p-5 rounded-sm" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)" }}>
      ...
      {/* Team cards + ownership — light section */}
      <div style={{
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="flex items-center gap-3 mb-12">
            <div className="h-[3px] w-10 bg-[#c9a840]" />
            <span className="text-[#c9a840] text-xs tracking-[0.3em] uppercase">The Team</span>
          </div>
